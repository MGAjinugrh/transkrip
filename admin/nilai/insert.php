            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form class="user" action="new.php" method="post">
                        ...
                        <div class="form-group">
                        <select name="kd_matkul" id="kd_matkul" class="form-control" required>
                            ...
                            <?php
                                ...
                                $mahasiswa = "SELECT * FROM matkul WHERE status = 'aktif' ORDER BY nama ASC";
                                $result = $conn->query($mahasiswa);
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ?>
                                        <option value="<?=$row['kd_matkul'];?>"><?=$row['nama'];?></option>    
                                        <?php
                                    }
                                }
                                $conn->close();
                        ...
                        <div class="form-group">
                            <input type="number" name="nilai" class="form-control" id="nilai" placeholder="Nilai" maxlength="3" required>
                        </div>
